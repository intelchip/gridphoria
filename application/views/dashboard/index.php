...
<div>
    ...
    if ($is_current_user_faculty_chair) {
        ?>
        <a href="<?php echo base_url("index.php?/dashboard/open_semester"); ?>" class="button"><i class="fi-plus large"></i> Open a Semester</a>
        <a href="<?php echo base_url("index.php?/dashboard/add_courses"); ?>" class="button"><i class="fi-plus large"></i> Add Course</a>
    <?php } ?>
    <a href="<?php echo base_url("index.php?/dashboard/view_semesters/all"); ?>" class="button"><i class="fi-list-bullet large"></i> View Semesters</a>
